...
class LoggingInterceptor extends Interceptor{
  ...
  onResponse(Response response) {
    ...
    if (response.statusCode.toString() == ExceptionHandle.success){
...
class AdapterInterceptor extends Interceptor{
  ...
  static const String failureFormat = "{\"respCode\":%s,\"respMsg\":\"%s\"}";
  static const String successFormat = "{\"respCode\":%s,\"data\":%s,\"respMsg\":%s}";
