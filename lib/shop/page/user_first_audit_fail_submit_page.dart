 ...
 * 重新申诉界面
 */
class UserFirstAuditFailSubmitPage extends StatefulWidget {

  const UserFirstAuditFailSubmitPage({Key key, this.userTaskId}) : super(key: key);

  final String userTaskId;
  @override
  _UserFirstAuditFailSubmitPageState createState() => _UserFirstAuditFailSubmitPageState();
}

class _UserFirstAuditFailSubmitPageState extends State<UserFirstAuditFailSubmitPage> {
