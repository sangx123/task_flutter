...
///商户审核用户提交的任务界面
class BusinessSecondAduitPage extends StatefulWidget {
  const BusinessSecondAduitPage({Key key, this.userTaskId}) : super(key: key);

  final String userTaskId;

  @override
  _BusinessSecondAduitPageState createState() => _BusinessSecondAduitPageState();
}

class _BusinessSecondAduitPageState extends State<BusinessSecondAduitPage> {
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: [
                      Gaps.hGap16,
                      Expanded(child: Text(
                        (userTaskModel==null)?"任务提交时间: ":"任务提交时间: "+userTaskModel.userSecondSubmitTaskTime,
                        style: TextStyle(
                            fontSize: 14,),
                      )),
                      Gaps.hGap16,
...
//    }
  ...
  Future<void> ApplyNo() async{
     //跳转到编辑原因
    NavigatorUtils.push(context, '${ShopRouter.businessSecondAuditFailReasonPage}?userTaskId=${widget.userTaskId}');
  }
}
