...
///用户查看审核失败的列表
class UserFirstAuditFailPage extends StatefulWidget {
  const UserFirstAuditFailPage({Key key, this.userTaskId}) : super(key: key);

  final String userTaskId;

  @override
  _UserFirstAuditFailPageState createState() => _UserFirstAuditFailPageState();
}

class _UserFirstAuditFailPageState extends State<UserFirstAuditFailPage> {
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: [
                      Gaps.hGap16,
                      Expanded(child: Text(
                        (userTaskModel==null)?"任务审核时间: ":"任务审核时间: "+userTaskModel.businessAuditFirstTime,
                        style: TextStyle(
                            fontSize: 14,),
                      )),
                      Gaps.hGap16,
...
//    }
  ...
  Future<void> ApplyOk() async{
    NavigatorUtils.push(context, '${ShopRouter.userFirstAuditFailSubmitPage}?userTaskId=${widget.userTaskId}');
  }
}
