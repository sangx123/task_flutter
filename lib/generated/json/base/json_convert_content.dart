...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
      case LoginEntity:
			...
			return recommandResultEntityFromJson(data as RecommandResultEntity, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case LoginEntity:
			...
			case RecommandResultEntity:
			return recommandResultEntityToJson(data as RecommandResultEntity);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'LoginEntity':
			...
			case 'RecommandResultEntity':
			return RecommandResultEntity().fromJson(json);    }
    return null;
  }
